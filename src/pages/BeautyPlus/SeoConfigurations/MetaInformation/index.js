...
const MetaInformation = () => {
   ...
   *
   * @param {object} updateData UpdateData props
   */
  const updateMetaInformation = (updateData) => {
    toggleModal(true);
    ...
    mutate(
      {
        ...
        payload: {
          ...
          data: {
            ...
            maxLengthH1Tag: editData?.maxLengthH1Tag,
            maxLengthMetaDescription: editData?.maxLengthMetaDescription,
            maxLengthMetaKeywords: editData?.maxLengthMetaKeywords,
            maxLengthMetaTitle: editData?.maxLengthMetaTitle,
  ...
  return (
    <Grid>
        ...
        showView && (
          ...
          >
            ...
            <Grid container spacing={5} className={fullWidth}>
              <CustomNumberInput
                label="maxLengthMetaTitle"
                value={catMetaInfoSetting?.maxLengthMetaTitle}
                edit={edit}
                validate={required()}
                typeText=""
              />
              <CustomNumberInput
                label="maxLengthMetaDescription"
                value={catMetaInfoSetting?.maxLengthMetaDescription}
                edit={edit}
                validate={required()}
                typeText=""
              />
              <CustomNumberInput
                label="maxLengthMetaKeywords"
                value={catMetaInfoSetting?.maxLengthMetaKeywords}
                edit={edit}
                validate={required()}
                typeText=""
              />
            ...
            <Grid container spacing={5} className={fullWidth}>
              <CustomNumberInput
                label="maxLengthH1Tag"
                value={catMetaInfoSetting?.maxLengthH1Tag}
                edit={edit}
                validate={required()}
                typeText=""
              />
      ...
      <SimpleModel
        dialogContent={<CommonDialogContent message={translate("updateConfirmationMessageOfMetaInformation")} />}
        showButtons
        dialogTitle=""
