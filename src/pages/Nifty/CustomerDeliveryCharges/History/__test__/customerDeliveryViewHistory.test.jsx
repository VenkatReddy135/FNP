...
import CustomerDeliveryChargesViewHistory from "../index";
...
describe("Customer Delivery View History list test cases", () => {
  let result;
  let labels;
  beforeEach(() => {
    const shallowRenderer = new ShallowRenderer();
    shallowRenderer.render(<CustomerDeliveryChargesViewHistory />);
    result = shallowRenderer.getRenderOutput();
    labels = result.props.children[1].props;
  });

  it("should render Customer Delivery View History list component", () => {
