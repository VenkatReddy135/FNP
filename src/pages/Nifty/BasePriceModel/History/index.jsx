...
/**
 * Component for BasePriceViewHistory list
 *
 * @param {object} props all the props needed for BasePriceViewHistory list
 * @returns {React.ReactElement} returns history List component
 */
const BasePriceViewHistory = (props) => {
...
export default memo(BasePriceViewHistory);
