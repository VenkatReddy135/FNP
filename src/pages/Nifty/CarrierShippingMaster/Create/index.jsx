 ...
 */
const CarrierShippingMasterCreate = () => {
  const initialState = {
    ...
    uomTypes: "Box Size",
    uomValues: "Actual",
    geoGroup: ["delhi-ecda=[110011,110012]"],
    timeSlot: ["testStats"],
  ...
  /**
   * @function addShippingRate callback function to update Shipping Rate
   * @param {object} data form data
   */
  const addShippingRate = useCallback((data) => {
    console.log(data);
  });
  ...
  return (
    <CarrierShippingMasterForm
      ...
      handleAction={addShippingRate}
    />
  );
};

export default React.memo(CarrierShippingMasterCreate);
