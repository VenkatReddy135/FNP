...
/**
 * Component for FC-Component View History View History list
 *
 * @param {object} props all the props needed for FC-Component View History list
 * @returns {React.ReactElement} returns history List component
 */
const FCComponentPriceMasterViewHistory = (props) => {
  ...
  const actionButtonsViewHistoryGrid = [
    {
      type: "Button",
  ...
  return (
    <>
      ...
      <SimpleGrid
        ...
        actionButtonsForGrid={actionButtonsViewHistoryGrid}
        actionButtonsForEmptyGrid={actionButtonsViewHistoryGrid}
...
export default memo(FCComponentPriceMasterViewHistory);
